...
The current Beta source build is `v2.0.14`, with the user-facing name
**TetoTV 2.0.14 Beta**. The repository determines that this is the Beta channel;
...
Public `1.0.2` and Beta `2.0.14` use Android `versionCode` `410001`, the same
