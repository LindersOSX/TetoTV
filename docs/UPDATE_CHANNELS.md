...
The current Beta release is `v2.0.8`, with the user-facing name
**TetoTV 2.0.8 Beta**. The repository determines that this is the Beta channel;
...
Public `1.0.2` and Beta `2.0.8` use Android `versionCode` `410001`, the same
