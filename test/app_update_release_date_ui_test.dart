...
AppReleaseInfo _release(String version, {DateTime? releasedAtUtc}) =>
    AppReleaseInfo(
      tagName: 'v$version',
      version: version,
      name: 'TetoTV $version',
      ...
      asset: AppReleaseAsset(
        ...
        apiUrl:
            'https://api.github.com/repos/LindersOSX/TetoTV/releases/assets/1',
        publicUrl:
            'https://github.com/LindersOSX/TetoTV/releases/download/'
