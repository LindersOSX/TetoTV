...
void main() {
  testWidgets('ordinary library route is available outside Developer Mode', (
    tester,
  ) async {
    ...
    expect(appRouter.routeInformationProvider.value.uri.path, '/library');
    expect(find.text('SEARCH YOUR MEDIA'), findsOneWidget);
    expect(find.text('Back'), findsNothing);
    expect(_railSelection(tester, const ValueKey('main-nav-my-list')), isTrue);
    expect(
      _railSelection(tester, const ValueKey('main-nav-settings')),
      isFalse,
    );
    expect(
    ...
    expect(_railSelection(tester, const ValueKey('main-nav-my-list')), isFalse);
